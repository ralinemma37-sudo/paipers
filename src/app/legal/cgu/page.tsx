...
import {
  TERMS_DISCLAIMER_FR,
  TERMS_LAST_UPDATED,
  termsOfServiceSectionsFr,
} from "@/legal/termsOfServiceFr";
import {
...
/**
 * Réf. : paipers-mobile/app/legal/cgu.tsx
 * Les mentions éditeur manquantes sont signalées via publisherPlaceholdersFr.
 */
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        {termsOfServiceSectionsFr.map((section) => (
