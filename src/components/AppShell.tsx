...
export default function AppShell({ children }: AppShellProps) {
  return (
    <div className="md:p-6 md:min-h-full">
      <div
        className="md:min-h-[calc(100vh-3rem)] md:overflow-hidden md:border md:border-[color:var(--paipers-border)] md:bg-[color:var(--paipers-card)] md:shadow-[var(--paipers-shadow-card)]"
